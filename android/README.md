# Compliment Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:compliments-api:1.1.13'
}
```
...
```java
import com.apiverve.compliments.ComplimentGeneratorAPIClient;
import com.apiverve.compliments.APIResponse;
import com.apiverve.compliments.APIException;

// Initialize the client
ComplimentGeneratorAPIClient client = new ComplimentGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("adult", true);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/compliments](https://docs.apiverve.com/ref/compliments)
...
- **Documentation:** [https://docs.apiverve.com/ref/compliments](https://docs.apiverve.com/ref/compliments)
- **Issues:** [GitHub Issues](https://github.com/apiverve/compliments-api/issues)
