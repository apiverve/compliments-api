...
namespace APIVerve\Compliments;
...
/**
 * Client for the Compliment Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/compliments?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/compliments';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ComplimentsClient] {$message}\n";
        }
    }
}
