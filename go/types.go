...
// Request contains the parameters for the Compliment Generator API.
//
// Parameters:
//   - adult: boolean - Include flirty/romantic compliments
type Request struct {
	Adult bool `json:"adult,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Compliment Generator API.
