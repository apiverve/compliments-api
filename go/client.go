// Package compliments provides a Go client for the Compliment Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/compliments?utm_source=go&utm_medium=readme
package compliments
...
const (
	baseURL        = "https://api.apiverve.com/v1/compliments"
	defaultTimeout = 30 * time.Second
)

// Client is the Compliment Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Compliment Generator API client.
...
// Execute makes a request to the Compliment Generator API with typed parameters.
//
...
//   - adult: boolean - Include flirty/romantic compliments
